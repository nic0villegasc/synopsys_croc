...
########################################################################################
# Script: REDHAWK_MCMM_CONFIG.analysis.rhsc.customized_python.local.tcl
# Version: T-2022.03
...
#INFO: Run analyze_rail for rail analysis, -submit_to_other_machine is not needed on local machine
analyze_rail -rail_scenario { static_customized_func.ss_125c static_func.ss_125c  static_func.ff_125c }
#
