##########################################################################################
# Tool: Formality Verification for Fusion Compiler Chip-Level 
# Version: T-2022.03
...
# of the files going into Fusion Compiler and the resulting Verilog netlist from Fusion Compiler.
#
# This script may be manually modified to perform other types of verifications as needed.
# 
# This script will use variables set in the FC RM scripts icc_pnr_setup.tcl and icc2_common_setup.tcl
# This script will use variables set in the ICC2 RM scripts icc_pnr_setup.tcl and design_setup.tcl
#
#################################################################################
...
#
# This sections uses FC RM variables to determine the type of reference design
#################################################################################
...
#################################################################################
# Read in the Implementation Design from FC-RM result
#
...
#
# If Fusion Compiler has performed scan re-ordering, the user will need to manually
