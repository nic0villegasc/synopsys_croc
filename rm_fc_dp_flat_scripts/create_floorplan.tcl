...
set REPORT_PREFIX ${CREATE_FLOORPLAN_FLAT_BLOCK_NAME}
...
copy_block -from ${DESIGN_NAME}/${COMPILE_DP_BLOCK_NAME} -to ${DESIGN_NAME}/${CREATE_FLOORPLAN_FLAT_BLOCK_NAME} 
current_block ${DESIGN_NAME}/${CREATE_FLOORPLAN_FLAT_BLOCK_NAME}
...
if { [lsearch $operations "INITIALIZE_FLOORPLAN"] >=0 } {
  ...
  save_block -as ${DESIGN_NAME}/initialize_floorplan
...
if { [lsearch $operations "PLACE_PINS"] >=0 } {
  ...
  save_block -as ${DESIGN_NAME}/place_pins_init
}
...
if { [lsearch $operations "MACRO_PLACEMENT"] >=0 } {
  ...
  save_block -as ${DESIGN_NAME}/macro_placement
}
