...
package tb_croc_pkg;
  ...
  localparam bit [31:0] BootAddrAddr    = SocCtrlBaseAddr + soc_ctrl_reg_pkg::SOC_CTRL_BOOTADDR_OFFSET;
  localparam bit [31:0] FetchEnAddr     = SocCtrlBaseAddr + soc_ctrl_reg_pkg::SOC_CTRL_FETCHEN_OFFSET;
  localparam bit [31:0] CoreStatusAddr  = SocCtrlBaseAddr + soc_ctrl_reg_pkg::SOC_CTRL_CORESTATUS_OFFSET;
