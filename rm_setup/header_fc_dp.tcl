...
lappend search_path ./rm_user_plugin_scripts ./rm_tech_scripts ./rm_fc_scripts ./rm_setup ./examples $WORK_DIR
if {$SUPPLEMENTAL_SEARCH_PATH != ""} {lappend search_path $SUPPLEMENTAL_SEARCH_PATH}
