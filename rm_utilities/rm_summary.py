...
report_list = ["report_qor","report_utilization","report_power","report_congestion","check_routes","report_clock_qor.summary","run_end.rpt"]
qor_dict={}
printResults=1
rpt_power=0
power_list = []
...
##print header
print ("{:<15} {:<8} {:<8} {:<6} {:<8} {:<8} {:<8} {:<6} {:<6} {:<6} {:<8} {:<8} {:<8} {:<8} {:<8} {:<8} {:<10} {:<10} {:<10} {:<9} {:<10} {:<10} {:<10} {:<10} {:10} {:10} {:10}".format(
'Step','Wns','Tns','Nvp','Hwns','Htns','Hnvp',
'Tran','Cap','Util','Gr%',
'Area','ClkArea','InstCnt','Buff/Inv','ICG',
'Leakage','Switching','Internal','Dynamic',
'Total','Nets','Wirelength','DRC',
...
for step in sList:
            ...
            if os.path.exists(fName):
              ...
              for line in rpt_file:
                  ...
                  if re.search("^Net Length:",line) is not None:
                      qor_dict[step+'_wirelength'] = line.split()[2]
    ...
    if printResults:
        print ("{:<15} {:<8} {:<8} {:<6} {:<8} {:<8} {:<8} {:<6} {:<6} {:<6} {:<8} {:<8} {:<8} {:<8} {:<8} {:<8} {:<10} {:<10} {:<10} {:.4} {:<10} {:<10} {:10} {:10} {:10} {:10} {:.1}".format(step,
